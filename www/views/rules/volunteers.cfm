<cfset rc.title = "Volunteer Rules" />	<!--- set a variable to be used in a layout --->

<cfoutput>
<h1>#rc.title#</h1>
<ol>
	<li>Safety is paramount. Food safety and equipment rules must be followed at all times. </li>
	<li>All hair needs to be restrained. Please bring a hat and something to bind long hair. Any hair that goes past the chin needs to be tied up. Hair nets will be provided. If you are unable to bind your hair or do not have a hat, you will be required to wear one.</li>
	<li>Gloves are required. Do not save and reuse gloves. To prevent cross contamination, you will be required to change gloves between handling different items. For example, after handling ham, you will need to get a new pair of gloves to handle turkey. If you touch a door, your face, your phone, change gloves. It's ok to go through several pairs of gloves, we have plenty on hand.</li>
	...
	<li>If you see a Chef moving with anything in their hands, do not move. Freeze, they will move around you. Having to to determine which way you are going makes it more difficult when carrying something hot and/or heavy and could cause an accident.</li>
